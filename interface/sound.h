...
static String FMOD_ErrorString(FMOD_RESULT errcode)
{
    ...
    case FMOD_ERR_INVALID_SPEAKER:        return "An invalid speaker was passed to this function based on the current speaker m ";
